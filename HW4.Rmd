...
GGPLOT.0 = ggplot(data= RMSE.2, aes(x=RMSE.2))+
             geom_histogram() + 
             geom_vline(xintercept = RMSE.1, col="red")
...
ANSWER: First we do log transformation on 'Apps'. From the residual plot, we can see that the residual plot is much better than for the non-trannon-transform one. We applied boxcox procedure to find the best y tranformation. And we can see 0 is close to the best parameter. For better intepratation of y, we admit log transformation on y.
