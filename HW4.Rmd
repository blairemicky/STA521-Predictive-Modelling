...
=======
Looking at the diagnostic plots, we find that using the overdispersed Poisson helped substantially. It brought the standard deviance residuals down from a max of an absolute value of 100 to a max of an absolute value of a little less than 4, and a max Std Pearson residual from 150 to less than 5.  There is still a trend in the Scale-Location plot.
>>>>>>> ce2229f920f747bed43261a8564601f3e56ef6a1
...
disperse.qpoi = Apps.qpoi$deviance/Apps.qpoi$df.residual
