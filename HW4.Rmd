...
pchisq(Apps.poi$deviance, Apps.poi$df.residual, lower.tail = F)
```
While the residual plot shows a fairly uniform distribution and all variables are labeled as being signficant, some of the standard deviance residuals are huge- indicating some cause for concern. Furthermore, the estimate of overdispersion is 683.7, indicating that this model is very overdispersed. This is borne out in the chi-square test, where we get 0, suggesting that the model is not an adequate fit.
