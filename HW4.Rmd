...
ANSWER: The RMSEs of the test data are substantially larger than the RSMEs of the training data. We expect them to be larger but given that they are in the far tail of the simulated histogram, this indicates we are doing pretty poorly for prediction. The p-values are 'r RMSE.0.test' and 'r RMSE.best.test' for the base model and the best model, respectively.
...
>>>>>>> 1bf65684003aba62c15368c8e51735dee44c9033
```
