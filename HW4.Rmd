...
```{r}
RMSE_o = c(RMSE.1,RMSE.1.bestlm,rmse.train.poi,rmse.qpoi.train,rmse.train.nb)
RMSE_t = c(RMSE.0.test, RMSE.best.test,rmse.test, rmse.qpoi.test,rmse.test.nb)
...
out = data.frame(row.names = row,RMSE_o,RMSE_t,coverage,pvalue)
kable(out)
```
